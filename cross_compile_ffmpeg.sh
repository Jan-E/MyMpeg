...
build_ffmpeg_release() {
  ...
  if [[ $shared = "ministat" ]]; then
    config_options="$config_options --enable-static --disable-shared --enable-gpl --enable-libgme --enable-libmodplug --enable-libmfx --enable-dxva2 --enable-avisynth --enable-libx264 --enable-libx265 --extra-libs=-lstdc++ --enable-nonfree --enable-libfdk-aac" # -enable-libfaac
  fi
