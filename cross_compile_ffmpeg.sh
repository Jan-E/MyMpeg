...
#  fi
  ...
  cd $output_dir
    ...
    config_options="$init_options --enable-libcaca --enable-gray --enable-libtesseract --enable-fontconfig --enable-gmp --enable-gnutls --enable-libass --enable-libbs2b --enable-libflite --enable-libfreetype --enable-libfribidi --enable-libgme --enable-libgsm --enable-libilbc --enable-libmodplug --enable-libmp3lame --enable-libopencore-amrnb --enable-libopencore-amrwb --enable-libopus --enable-libsnappy --enable-libsoxr --enable-libspeex --enable-libtheora --enable-libtwolame --enable-libvo-amrwbenc --enable-libvorbis --enable-libvpx --enable-libwebp --enable-libzimg --enable-libzvbi --enable-libmysofa --enable-libopenjpeg --enable-libopenh264"
#    if [[ $compiler_flavors != "native" ]]; then
...
build_my_ffmpeg() {
  ...
  if [[ $shared = "ministat" ]] || [[ $shared = "ministat_w32threads" ]]; then
    ...
    config_options="$config_options --enable-gpl --enable-libx264 --enable-amf --enable-dxva2 --enable-ffnvcodec --enable-cuvid --enable-d3d11va $arch_opts --disable-doc"
  fi
...
apply_my_ffmpeg_patches_no_git() {
  git stash
  apply_ffmpeg_patch_no_git https://raw.githubusercontent.com/Jan-E/mympeg/master/ffmpeg_patches/ass_fontsize.patch
  apply_ffmpeg_patch_no_git https://raw.githubusercontent.com/Jan-E/mympeg/master/ffmpeg_patches/subtitles_non_fatal.patch
  apply_ffmpeg_patch_no_git https://raw.githubusercontent.com/Jan-E/mympeg/master/ffmpeg_patches/asfenc.patch
  apply_ffmpeg_patch_no_git https://raw.githubusercontent.com/Jan-E/mympeg/master/ffmpeg_patches/movenc.patch
...
build_my_ffmpeg_6.0() {
  ...
  local shared=$build_ffmpeg_shared
  local output_dir="ffmpeg_git"
  local download_url="http://ffmpeg.org/releases/ffmpeg-6.0.tar.bz2"
  ...
  if [[ $shared = "shared" ]] || [[ $shared = "minimal" ]] ; then
    ...
    output_dir=ffmpeg_shared
	mkdir ${output_dir}
	cp -pR ffmpeg-6.0/* ${output_dir}/ && rm -rf ffmpeg-6.0
  ...
  if [[ ! -f 'my-ffmpeg-patches.done' ]]; then
    apply_my_ffmpeg_patches_no_git
    patch -p1</mnt/winshare/MyMpeg/patches/suppress-skipping-nal-unit-63-6.0.patch
  fi
  apply_patch file://$patch_dir/frei0r_load-shared-libraries-dynamically.diff
  apply_patch file://$patch_dir/built-with-on-today.diff
