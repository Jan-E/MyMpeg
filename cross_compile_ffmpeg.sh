...
build_libutvideo() {
  download_and_unpack_file https://github.com/downloads/Jan-E/FFmpeg/utvideo-11.1.1-src.zip utvideo-11.1.1
  cd utvideo-11.1.1
...
build_ffmpeg() {
  ...
  apply_ffmpeg_patch https://raw.github.com/Jan-E/mympeg/master/ffmpeg_patches/experiment.patch
